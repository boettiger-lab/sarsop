#' write_Nmdp: writing non-stationary MDP files
#'
#' @inheritParams pomdp
#' @param P_full transition matrix for uncontrolled variables
#' @param P_par transition fro regular states
#' @param O observation matrix
#' @param R reward
#' @param gamma discount factor
#' @param b_full initial belief for uncontrolled variable
#' @param b_par initial belief of regular states
...
#' @export
write_Nmdp <- function(P_full, P_par, O, R, gamma, b_full, b_par,file = "input.mdpx", digits = 4, digits2 = 10, format = "f"){
  ...
  header_zar <- paste0(
    ...
    '\n',
    paste0('<NumValues>', dim(P_par)[[1]],'</NumValues>'),
    '\n',
    '</ObsVar>',
    '\n\n',
